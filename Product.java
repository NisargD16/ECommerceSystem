...
public class Product implements Comparable
{
	...
	{
		Product otherP = (Product) other;  // converted the "other" Object to a Product Object calling it otherP
		return this.id.equals(otherP.id);  // returns true or false whether both products' Id matches 
	}

	public int compareTo(Object o) //compareTo method that compares the name of two products to help with printByPrice method
	{
		Product p = (Product) o;
